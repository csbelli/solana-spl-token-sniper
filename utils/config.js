...
exports.ownerAddress = ''; //wallet address - public key
exports.wallet = web3_js_1.Keypair.fromSecretKey(bs58.decode('')); //wallet private key
exports.connection = new web3_js_1.Connection(''); //RPC connection URL
exports.websocketConnection = ''; //web socket connection URL
exports.amtBuySol = '0.001'; //INTEGER AMOUNT OF SOL TO USER PER SWAP, EX. 0.001
